...
@NgModule({
  ...
  declarations: [KaartComponent, KaartWmsLaagComponent, KaartVectorLaagComponent, KaartKnoppenComponent],
  exports: [KaartComponent, KaartWmsLaagComponent, KaartVectorLaagComponent, KaartKnoppenComponent]
})
